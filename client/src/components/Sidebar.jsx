  ...
  return (
    <div className="flex flex-col justify-between bg-white h-full overflow-y-scrikk min-w-210 hide-scrollbar">
      <div className="flex flex-col mb-5 ">
        ...
        >
          <img src={logo2} alt="logo" className="w-full h-20 object-cover" />
        </Link>
      ...
      {
        user ? (
          <Link to={`user-profile/${user._id}`} className="flex my-5 mb-3 gap-2 p-2 items-center bg-white rouded-lg shadow-lg mx-3"onClick={handleCloseSidebar}> 
